...
export default class App extends Component {
  ...
  render() {
    ...
    const { deleteItem, addItem, onToggleDone, onToggleImportant, filtered, search, } = this;

    const visiableItems = filtered(search(todoData, term), filter)
    ...
    return (
      <div className="todo-app">
        ...
        <div className="top-panel d-flex">
          ...
          <ItemStatusFilter filter ={filter} filterChange = {this.onFilterChange}/>
        </div>
